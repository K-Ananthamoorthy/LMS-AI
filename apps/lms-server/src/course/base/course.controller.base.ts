...
import { StudyMaterialFindManyArgs } from "../../studyMaterial/base/StudyMaterialFindManyArgs";
import { StudyMaterial } from "../../studyMaterial/base/StudyMaterial";
...
export class CourseControllerBase {
  ...
  async findStudyMaterials(
    ...
    const query = plainToClass(StudyMaterialFindManyArgs, request.query);
  ...
  @common.Post("/:id/studyMaterials")
  @nestAccessControl.UseRoles({
    resource: "Course",
    action: "update",
    possession: "any",
  })
  async connectStudyMaterials(
    @common.Param() params: CourseWhereUniqueInput,
    @common.Body() body: StudyMaterialWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      studyMaterials: {
        connect: body,
  ...
  @common.Patch("/:id/studyMaterials")
  @nestAccessControl.UseRoles({
    resource: "Course",
    action: "update",
    possession: "any",
  })
  async updateStudyMaterials(
    @common.Param() params: CourseWhereUniqueInput,
    @common.Body() body: StudyMaterialWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/studyMaterials")
  @nestAccessControl.UseRoles({
    resource: "Course",
    action: "update",
    possession: "any",
  })
  async disconnectStudyMaterials(
    @common.Param() params: CourseWhereUniqueInput,
    @common.Body() body: StudyMaterialWhereUniqueInput[]
  ): Promise<void> {
    const data = {
