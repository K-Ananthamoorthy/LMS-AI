...
import { PersonalAssistanceFindManyArgs } from "../../personalAssistance/base/PersonalAssistanceFindManyArgs";
import { PersonalAssistance } from "../../personalAssistance/base/PersonalAssistance";
...
export class StudentControllerBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @common.Get("/:id/personalAssistances")
  ...
  async findPersonalAssistances(
    @common.Req() request: Request,
    @common.Param() params: StudentWhereUniqueInput
  ): Promise<PersonalAssistance[]> {
    const query = plainToClass(PersonalAssistanceFindManyArgs, request.query);
  ...
  @common.Post("/:id/personalAssistances")
  @nestAccessControl.UseRoles({
    resource: "Student",
    action: "update",
    possession: "any",
  })
  async connectPersonalAssistances(
    @common.Param() params: StudentWhereUniqueInput,
    @common.Body() body: PersonalAssistanceWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      personalAssistances: {
        connect: body,
  ...
  @common.Patch("/:id/personalAssistances")
  @nestAccessControl.UseRoles({
    resource: "Student",
    action: "update",
    possession: "any",
  })
  async updatePersonalAssistances(
    @common.Param() params: StudentWhereUniqueInput,
    @common.Body() body: PersonalAssistanceWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/personalAssistances")
  @nestAccessControl.UseRoles({
    resource: "Student",
    action: "update",
    possession: "any",
  })
  async disconnectPersonalAssistances(
    @common.Param() params: StudentWhereUniqueInput,
    @common.Body() body: PersonalAssistanceWhereUniqueInput[]
  ): Promise<void> {
    const data = {
